...
// The security side's own landing page. botwatch's security work (honeypots,
// payload analysis, threat-actor profiling) is a free research side-project —
// this is its front door, kept visually distinct from the AI-readiness product
// that is the platform's commercial focus. Content moved here from the old
// homepage when the two sides were split apart.
    ...
    <main className="landing">
      <section className="hero-section">
        ...
        <h1 className="hero-title">
          Tracking the bad bots of the world
        </h1>
        <p className="hero-desc">
          Alongside our AI-readiness work, botwatch runs an open security research project:
          a network of honeypots that studies how automated crawlers and malicious bots probe
          web infrastructure in the wild. Every request is a data point — this is what we've
          collected over time.
        </p>
        <div className="hero-actions">
          <Link to="/intel" className="btn-primary">Live Intel →</Link>
          <Link to="/data" className="btn-ghost">Free threat data</Link>
          <Link to="/willowbot" className="btn-ghost">Meet Willowbot</Link>
        </div>
      </section>
